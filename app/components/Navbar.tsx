...
import { CartDropdown } from '@/app/context/CartContext'; 
...
export default function Navbar() {
  ...
  const getLinkClass = (path: string) => {
    ...
    if (path === '/productos' && pathname.startsWith('/productos')) return "nav-link active";
    if (path === '/blogs' && pathname.startsWith('/blogs')) return "nav-link active";
